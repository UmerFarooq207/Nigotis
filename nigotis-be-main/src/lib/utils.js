export const currencies = [
  ...
  // Top Arab Currencies
  { code: "AED", name: "United Arab Emirates Dirham", symbol: "د.إ" }, // UAE Currency
  { code: "SAR", name: "Saudi Riyal", symbol: "﷼" }, // Saudi Arabia Currency
  { code: "QAR", name: "Qatari Riyal", symbol: "﷼" }, // Qatar Currency
  { code: "KWD", name: "Kuwaiti Dinar", symbol: "د.ك" }, // Kuwait Currency
  { code: "OMR", name: "Omani Rial", symbol: "﷼" }, // Oman Currency8
  { code: "BHD", name: "Bahraini Dinar", symbol: ".د.ب" }, // Bahrain Currency
  { code: "EGP", name: "Egyptian Pound", symbol: "£" }, // Egypt Currency
  { code: "LYD", name: "Libyan Dinar", symbol: "ل.د" }, // Libya Currency
  { code: "JOD", name: "Jordanian Dinar", symbol: "د.ا" }, // Jordan Currency
  //south aisa
