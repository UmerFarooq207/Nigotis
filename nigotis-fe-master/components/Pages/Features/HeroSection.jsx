  ...
  return (
    <section
      ...
      style={{
        ...
        /* min-height is handled by the inner grid so the section
           shrinks exactly to content — no extra whitespace below */
      }}
    >
      ...
      <div
        className="
          ...
          items-end          /* both columns bottom-align inside the row */
        "
      >
        ...
        <div className="flex flex-col gap-6 lg:gap-7 max-w-xl pb-4 lg:pb-20 self-center">
          ...
          >
            ...
            <span className="text-[#003B6D] font-bold tracking-widest text-xs md:text-sm uppercase">
              Your Intelligent Business Command Layer
            </span>
          </motion.div>
          ...
          >
            From invoicing and payroll to clients, expenses, and reports —
            Nigotis AI brings every part of your operations into one
          ...
          >
            <ButtonPrimary bggray text="Get Started Free" link="/auth/signup" />
          </motion.div>
        ...
        >
          {/* Floating graph — top-left of the image block */}
          <motion.div
          ...
          <Image
            src="/features/women1.png"
            width={560}
            height={700}
            alt="Business professional using Nigotis on WhatsApp"
            className="
              object-contain object-bottom
              z-10
              w-[240px] sm:w-[340px] md:w-[420px] lg:w-[480px] xl:w-[530px]
              h-auto
              block
              drop-shadow-2xl
            "
