...
import { ChevronDown, ChevronRight, Edit3, Plus, Trash2, Upload } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
    ...
    <>
      <div className="px-4 pb-4">
        <div className="py-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {!isSubAccount && (
              <div>
                ...
                <Select value={roleFilter} onValueChange={setRoleFilter}>
                  <SelectTrigger className="bg-white" id="role">
          ...
          <div className="mb-4 text-sm text-gray-500">Total: {filteredItems.length}</div>
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50">
                {isSelectEmp && <TableHead className="font-bold">Actions</TableHead>}
                <TableHead className="font-bold">Expand</TableHead>
                <TableHead className="font-bold">Emp ID</TableHead>
                <TableHead className="font-bold">Name</TableHead>
                <TableHead className="font-bold">Email</TableHead>
                <TableHead className="font-bold">Role</TableHead>
                <TableHead className="font-bold">Salary Type</TableHead>
                <TableHead className="font-bold">Phone</TableHead>
                <TableHead className="font-bold">Job Role</TableHead>
                {!isSelectEmp && <TableHead className="font-bold text-center">Actions</TableHead>}
              </TableRow>
            </TableHeader>
            <TableBody>
                        ...
                        <div className=" grid grid-cols-2 gap-4">
                          {employee?.jobInfo?.payrollId ? (
                            ...
                            <div className=" col-span-2 w-full flex items-center justify-between border-b border-gray-700">
                              {" "}
                              <p className="font-semibold">
                                Payroll structure was not found for this
                                employee:
                              </p>{" "}
