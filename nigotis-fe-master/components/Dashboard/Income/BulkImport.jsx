    ...
    <MainDashboardContentSkeleton title={null}>
      <div className="flex justify-between md:items-center mb-6 px-4 flex-col md:flex-row gap-4 pt-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Bulk Import Incomes</h2>
            <p className="text-sm text-gray-500">Upload an Excel file to add multiple incomes</p>
          </div>
        </div>
      </div>
